...
<body>
  <header>
  <nav class="navbar">
    <h1><span>ĐÂY LÀ SẢN PHẨM BÀI TẬP PHỤC VỤ CHẤM ĐIỂM MÔN HỌC, KHÔNG NHẰM MỤC ĐÍCH THƯƠNG MẠI.</span></h1>
  <button class="show-menu-btn" onclick="toggleMenu()"></button>
    <ul class="menu">
      ...
      <li><a href="index.php?page_layout=danhsachxemsau">DANH SÁCH YÊU THÍCH</a></li>
      <?php 
        session_start();
