...
<body>
    ...
    <div class="chitietphim">
        ...
        if ($rowmoviedetail != null) {
            ...
            echo "<img src='./hinhanhphim/" . $rowmoviedetail['img'] . "' alt='Movie Image' style='width: 210px; height: 330px;'>";
            echo "</div>";
  ...
  <div class='left-column'>
    ...
    if($rowtheloai != null){
        ...
        while ($rowmoviesNew = $ListMovieNew->fetch_array(MYSQLI_ASSOC)) {
            ...
            echo "<img class='hinhanhphim_new' src='./hinhanhphim/" . $rowmoviesNew["img"] . "' style='width: 140px; height: 180px;'>";
